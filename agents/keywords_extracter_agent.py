...
prompt_template = ChatPromptTemplate.from_messages([
    ("system", 
     ...
     "Your task is to extract **5 to 7 complete, meaningful search phrases** from the given research topic. "
...
result = chain.invoke({
    "topic": "Predicting Disease Progression Using OCT Data. Predicting prognosis and number of anti VEGF injections needed and visual acuity improvement  in DME, CNVM  based on OCT , Age ,Vision, clinical risk factors."})
print("Extracted Keywords:", result.content)